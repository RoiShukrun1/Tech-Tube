...
const videoSchema = new Schema({
    id: { type: String, required: true }, // Video ID
    ...
    date: { type: String}, // Date when the video was uploaded, default is current date/time
    ...
    comments: [{
        ...
        date: { type: String }, // Date when the comment was posted
