...
public class VideoViewModelVWP extends ViewModel {

    private final MutableLiveData<List<Video>> videos;
    private final RelatedVideosRepository repository;

    /**
     * Constructor for MainVideoViewModel.
     * Initializes the repository and loads the videos.
     */
    public VideoViewModelVWP() {
        repository = RelatedVideosRepository.getInstance();
